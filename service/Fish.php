...
$sql = "SELECT product_id, product_name, product_desc, product_category, product_qty, product_price, product_rating, product_profile FROM product where product_category = 'fish'";
