...
<head>
    ...
    <title>Fish Listing | AgriMarket Solutions</title>
...
<body>
    <div class="page-header">
        <div class="container">
            <h1>Fish List</h1>
            <p class="subtitle">Dive into fresh, sustainably sourced seafood and fish.</p>
        </div>
    </div>

    <div class="container">
        <div class="search-container">
            <form method="get" action="fish.php" class="search-form">
                <input type="text" name="query" class="search-input" placeholder="Search for fishes..." 
        ...
        <?php if (empty($products)): ?>
            <div class="no-results">
                ...
                <p>No fishes found. Please try a different search term.</p>
            </div>
        <?php else: ?>
