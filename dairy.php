...
<head>
    ...
    <title>Dairy Listing | AgriMarket Solutions</title>
...
<body>
    <div class="page-header">
        <div class="container">
            <h1>Dairy List</h1>
            <p class="subtitle">Discover rich and creamy dairy products from local farms.</p>
        </div>
    </div>

    <div class="container">
        <div class="search-container">
            <form method="get" action="dairy.php" class="search-form">
                <input type="text" name="query" class="search-input" placeholder="Search for dairy..." 
        ...
        <?php if (empty($products)): ?>
            <div class="no-results">
                ...
                <p>No dairy found. Please try a different search term.</p>
            </div>
        <?php else: ?>
