...
require_once 'service/Vegetable.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Vegetable Listing | AgriMarket Solutions</title>
...
<body>
    <div class="page-header">
        <div class="container">
            ...
            <p class="subtitle">Enjoy vibrant, freshly harvested vegetables from local growers.</p>
        </div>
    </div>

    <div class="container">
        <div class="search-container">
            <form method="get" action="vegetable.php" class="search-form">
                <input type="text" name="query" class="search-input" placeholder="Search for vegetables..." 
        ...
        <?php if (empty($products)): ?>
            <div class="no-results">
                ...
                <p>No vegetables found. Please try a different search term.</p>
            </div>
        <?php else: ?>
