...
require_once 'service/Livestock.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Livestock Listing | AgriMarket Solutions</title>
...
<body>
    <div class="page-header">
        <div class="container">
            <h1>Livestock List</h1>
            <p class="subtitle">Find high-quality, ethically raised livestock products.</p>
        </div>
    </div>

    <div class="container">
        <div class="search-container">
            <form method="get" action="livestock.php" class="search-form">
                <input type="text" name="query" class="search-input" placeholder="Search for livestocks..." 
        ...
        <?php if (empty($products)): ?>
            <div class="no-results">
                ...
                <p>No livestocks found. Please try a different search term.</p>
            </div>
        <?php else: ?>
