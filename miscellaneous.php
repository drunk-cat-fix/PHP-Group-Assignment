...
<head>
    ...
    <title>Miscellaneous Listing | AgriMarket Solutions</title>
...
<body>
    <div class="page-header">
        <div class="container">
            ...
            <p class="subtitle">Uncover unique and specialty farm goods.</p>
        </div>
    </div>

    <div class="container">
        <div class="search-container">
            <form method="get" action="miscellaneous.php" class="search-form">
                <input type="text" name="query" class="search-input" placeholder="Search for miscellaneous..." 
        ...
        <?php if (empty($products)): ?>
            <div class="no-results">
                ...
                <p>No miscellaneous found. Please try a different search term.</p>
            </div>
        <?php else: ?>
