...
require_once 'service/Forestry.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Forestry Listing | AgriMarket Solutions</title>
...
<body>
    <div class="page-header">
        <div class="container">
            <h1>Forestry List</h1>
            <p class="subtitle">Explore natural and eco-friendly forestry products.</p>
        </div>
    </div>

    <div class="container">
        <div class="search-container">
            <form method="get" action="forestry.php" class="search-form">
                <input type="text" name="query" class="search-input" placeholder="Search for forestry..." 
        ...
        <?php if (empty($products)): ?>
            <div class="no-results">
                ...
                <p>No forestry found. Please try a different search term.</p>
            </div>
        <?php else: ?>
