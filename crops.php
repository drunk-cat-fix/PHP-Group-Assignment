...
<head>
    ...
    <title>Crop Listing | AgriMarket Solutions</title>
...
<body>
    <div class="page-header">
        <div class="container">
            <h1>Crop List</h1>
            <p class="subtitle">Explore fresh and locally grown crops</p>
        </div>
    </div>

    <div class="container">
        <div class="search-container">
            <form method="get" action="crops.php" class="search-form">
                <input type="text" name="query" class="search-input" placeholder="Search for crops..." 
        ...
        <?php if (empty($products)): ?>
            <div class="no-results">
                ...
                <p>No crops found. Please try a different search term.</p>
            </div>
        <?php else: ?>
